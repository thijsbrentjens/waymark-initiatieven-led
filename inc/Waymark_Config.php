...
class Waymark_Config {
	...
	public static function init() {
		...
		self::$data = array(
			...
			'lines' => array(
				'line_types' => array(
					'line_title' => esc_html__('Red', 'waymark-plugin') . $multi_value_seperator . esc_html__('Green', 'waymark-plugin') . $multi_value_seperator . esc_html__('Blue', 'waymark' ),
			...
			'shapes' => array(
				'shape_types' => array(
					'shape_title' => esc_html__('Red', 'waymark-plugin') . $multi_value_seperator . esc_html__('Green', 'waymark-plugin') . $multi_value_seperator . esc_html__('Blue', 'waymark' ),
