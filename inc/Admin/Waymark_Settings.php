    ...
    add_action('admin_notices', array($this, 'admin_notices'));
				...
				'layers' => array(
					...
					'fields' => array(
						'layer_name' => array(
							...
							'type' => 'text',
							'class' => '',				
							'title' => '<u>' . esc_html__('Basemap', 'waymark-plugin') . '</u> ' . esc_html__('Name', 'waymark' ),
		...
		$this->tabs['markers'] = array(
			...
			'sections' => array(
				'marker_types' => array(
					'repeatable' => true,
					'title' => esc_html__('Marker', 'waymark-plugin') . ' ' . esc_html__('Types', 'waymark' ),
					...
					'fields' => array(
						'marker_title' => array(
							...
							'title' => '<u>' . esc_html__('Marker', 'waymark-plugin') . '</u> ' . esc_html__('Label', 'waymark' ),
						...
						'marker_colour' => array(
							...
							'title' => '<span class="waymark-invisible">' . esc_html__('Marker', 'waymark-plugin') . '</span> ' . esc_html__('Colour', 'waymark' ),
						...
						'marker_icon' => array(
							...
							'type' => 'text',
							'class' => 'waymark-short-input',				
							'title' => '<span class="waymark-invisible">' . esc_html__('Marker', 'waymark-plugin') . '</span> ' . esc_html__('Icon Name', 'waymark' ),
						...
						'icon_colour' => array(
							...
							'title' => '<span class="waymark-invisible">' . esc_html__('Marker', 'waymark-plugin') . '</span> ' . esc_html__('Icon Colour', 'waymark' ),
						...
						'marker_display' => array(
							...
							'id' => 'marker_display',
							'type' => 'boolean',
							'title' => '<span class="waymark-invisible">' . esc_html__('Marker', 'waymark-plugin') . '</span> ' . esc_html__('Show Initially', 'waymark' ),
		...
		$this->tabs['lines'] = array(
			...
			'sections' => array(
				'line_types' => array(
					'repeatable' => true,
					'title' => esc_html__('Line', 'waymark-plugin') . ' ' . esc_html__('Types', 'waymark' ),
					...
					'fields' => array(
						'line_title' => array(
							...
							'type' => 'text',
							'class' => 'waymark-uneditable',				
							'title' => '<u>' . esc_html__('Line', 'waymark-plugin') . '</u> ' . esc_html__('Label', 'waymark' ),
						...
						'line_colour' => array(
							...
							'type' => 'text',
							'class' => 'waymark-short-input waymark-colour-picker',				
							'title' => '<span class="waymark-invisible">' . esc_html__('Line', 'waymark-plugin') . '</span> ' . esc_html__('Colour', 'waymark' ),
						...
						'line_weight' => array(
							...
							'type' => 'text',
							'class' => 'waymark-short-input',				
							'title' => '<span class="waymark-invisible">' . esc_html__('Line', 'waymark-plugin') . '</span> ' . esc_html__('Weight', 'waymark' ),
						...
						'line_display' => array(
							...
							'id' => 'line_display',
							'type' => 'boolean',
							'title' => '<span class="waymark-invisible">' . esc_html__('Line', 'waymark-plugin') . '</span> ' . esc_html__('Show Initially', 'waymark' ),
		...
		$this->tabs['shapes'] = array(
			...
			'sections' => array(
				'shape_types' => array(
					'repeatable' => true,
					'title' => esc_html__('Shape', 'waymark-plugin') . ' ' . esc_html__('Types', 'waymark' ),
					...
					'fields' => array(
						'shape_title' => array(
							...
							'type' => 'text',
							'class' => 'waymark-uneditable',				
							'title' => '<u>' . esc_html__('Shape', 'waymark-plugin') . '</u> ' . esc_html__('Label', 'waymark' ),
						...
						'shape_colour' => array(
							...
							'type' => 'text',
							'class' => 'waymark-short-input waymark-colour-picker',				
							'title' => '<span class="waymark-invisible">' . esc_html__('Shape', 'waymark-plugin') . '</span> ' . esc_html__('Colour', 'waymark' ),
						...
						'fill_opacity' => array(
							...
							'type' => 'text',
							'class' => 'waymark-short-input',				
							'title' => '<span class="waymark-invisible">' . esc_html__('Shape', 'waymark-plugin') . '</span> ' . esc_html__('Fill Opacity', 'waymark' ),
						...
						'shape_display' => array(
							...
							'id' => 'shape_display',
							'type' => 'boolean',
							'title' => '<span class="waymark-invisible">' . esc_html__('Shape', 'waymark-plugin') . '</span> ' . esc_html__('Show Initially', 'waymark' ),
				...
				'inputs' => array(
					...
					'fields' => array(
						'meta_title' => array(
							...
							'type' => 'text',
							'class' => '',				
							'title' => '<u>' . esc_html__('Meta', 'waymark-plugin') . '</u> ' . esc_html__('Title', 'waymark' ),
						...
						'meta_default' => array(
							...
							'type' => 'text',
							'class' => '',				
							'title' => '<span class="waymark-invisible">' . esc_html__('Meta', 'waymark-plugin') . '</span> ' . esc_html__('Default', 'waymark' ),
						...
						'meta_tip' => array(
							...
							'type' => 'text',
							'class' => '',				
							'title' => '<span class="waymark-invisible">' . esc_html__('Meta', 'waymark-plugin') . '</span> ' . esc_html__('Tip', 'waymark' ),
						...
						'meta_type' => array(
							...
							'type' => 'select',
							'class' => '',				
							'title' => '<span class="waymark-invisible">' . esc_html__('Meta', 'waymark-plugin') . '</span> ' . esc_html__('Type', 'waymark' ),
						...
						'meta_options' => array(
							...
							'type' => 'text',
							'class' => '',				
							'title' => '<span class="waymark-invisible">' . esc_html__('Meta', 'waymark-plugin') . '</span> ' . esc_html__('Options', 'waymark' ),
